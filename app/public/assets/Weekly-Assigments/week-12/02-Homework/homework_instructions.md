...
In this activity, you'll be creating an Amazon-like storefront with the MySQL skills you learned this week. cd ..
...
1. Create a MySQL Database called `bamazon`. COMPLETE

2. Then create a Table inside of that database called `products`. COMPLETE

3. The products table should have each of the following columns: COMPLETE
...
4. Populate this database with around 10 different products. (i.e. Insert "mock" data rows into this database and table). COMPLETE
